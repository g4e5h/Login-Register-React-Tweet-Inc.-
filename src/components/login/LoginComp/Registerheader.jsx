...
function Registerheader(props) {
  ...
  return (
    <>
     ...
     <button className='login-heading' onClick={switchfunction} style={{color:"gray",border:"1px solid white"}} type='button'>Login</button>
     <span style={{fontSize:"2rem",marginRight:"3%"}}>/</span>
     <button className='register-button' onClick={switchfunction} style={{fontSize:"3.2rem",color:"#1DA1F2"}} type='button'>Register</button>
